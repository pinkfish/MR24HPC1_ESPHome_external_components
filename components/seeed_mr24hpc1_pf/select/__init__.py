...
SceneModeSelect = mr24hpc1pf_ns.class_("SceneModeSelect", select.Select)
MotionTimeoutSelect = mr24hpc1pf_ns.class_("MotionTimeoutSelect", select.Select)
...
async def to_code(config):
    ...
    if scenemode_config := config.get(CONF_SCENE_MODE):
        ...
        await cg.register_parented(s, config[CONF_MR24HPC1PF_ID])
